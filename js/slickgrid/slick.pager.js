...
(function ($) {
    function SlickGridPager(dataView, grid, $container) {
        ...
        function constructPagerUI() {
            ...
            $settings
                .append("<span class='slick-pager-settings-expanded' style='display:none'>Show: <a data=0>All</a><a data='-1'>Auto</a><a data=20>20</a><a data=50>50</a><a data=100>100</a></span>");
